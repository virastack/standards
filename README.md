...
A unified suite of ESLint, Prettier, and architectural rules to enforce absolute code integrity.
...
Licensed under the <a href="https://github.com/virastack/standards/blob/main/LICENSE">MIT License</a>.
